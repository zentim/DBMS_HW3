...
<?php
  // 取得SQL指令
  $SQL = "SELECT B_ID, B_name, Price, ISBN, Author, book.P_ID, P_name, P_tel FROM book, publisher WHERE book.P_ID = publisher.P_ID";
...
<body>
    ...
    <h2>資料庫管理系統 (書籍管理)</h2><a href="../index.html">回首頁</a>
    <hr>
